...
void Engine::shutdown()
{
    ...
    vkDestroyPipelineLayout(vulkanApp->device, pipelineLayout, nullptr);
...
void Engine::createGraphicsPipeline()
{
    ...
    vkDestroyShaderModule(vulkanApp->device, fragShaderModule, nullptr);
    vkDestroyShaderModule(vulkanApp->device, vertShaderModule, nullptr);
}
