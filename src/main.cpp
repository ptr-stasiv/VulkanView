...
private:
    ...
    void createSyncObjects() {
        ...
        {
            std::cout << "Vulkan create semaphores successfully!" << std::endl;
        }
    }
    ...
    void createCommandBuffer()
    {
        ...
        {
            std::cout << "Vulkan command buffers allocated successfully!" << std::endl;
        }
    }
    ...
    void createFramebuffers()
    {
        ...
        for (size_t i = 0; i < swapChainImageViews.size(); i++) {
            ...
            {
              std::cout << "Vulkan framebuffer created successfully! " << i + 1 << std::endl;
            }
        }
    }
    ...
    void createImageViews() 
    {
        ...
        for (size_t i = 0; i < swapChainImages.size(); i++) {
            ...
            {
                std::cout << "Vulkan image view created successfully! " << i + 1 << std::endl;
            }
        }
    }
    ...
    void createLogicalDevice()
    {
        ...
        {
			std::cout << "Vulan logical device created successfully!" << std::endl;
        }
